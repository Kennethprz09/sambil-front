...
export default {
  ...
  data() {
    return {
      status: '',
      password: 'Sambil.2022*',
      userEmail: 'admin@sambil.com',
      sideImg: require('@/assets/images/logo/sambil-logo.png'),
      imgLogo: require('@/assets/images/logo/sambil-logo.png'),
  ...
  computed: {
    ...
    imgUrl() {
      if (store.state.appConfig.layout.skin === 'dark') {
        ...
        this.sideImg = require('@/assets/images/logo/sambil-logo-blanco.png')
        return this.sideImg
      }
      return this.sideImg
    },
