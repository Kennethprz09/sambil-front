                ...
                <b-row v-for="(item, index) in form.products" :id="item.id" :key="index" ref="row" class="mb-2">
                    <b-col>
                        <b-form-select v-model="form.products[index].name" :options="products" :reduce="(val) => val.value"
                            @change="searchProduct(index, form.products[index].name)" disabled />
                    </b-col>
                    <b-col>
                    ...
                    <b-col>
                        <select v-model="form.products[index].tax" multiple="multiple" class="custom-select" id="BVID__125"
                            ...
                            <template v-for="(item, indexS) in form.products[index].tax">
                        ...
                        <!-- <v-select @input="changeTax(index)" v-model="form.products[index].tax" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" label="text" multiple :options="form.products[index].taxselect" disabled sty/> -->
                    </b-col>
                    <b-col>
