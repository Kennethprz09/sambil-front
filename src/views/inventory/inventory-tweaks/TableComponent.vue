        ...
        <b-row>
          ...
          >
            <span
              class="text-muted"
            >
              Viendo del {{ dataMeta.from }} al {{ dataMeta.to }} de {{ dataMeta.of }} registros</span>
          </b-col>
          <!-- Pagination -->
          <b-col
            cols="12"
...
export default {
  ...
  data() {
    return {
      ...
      searchQuery: "",
      inputs: [
        { value: "id", title: "Número" },
        { value: "reason", title: "Fecha" },
        { value: "number_identification", title: "Almacen" },
        { value: "mobil", title: "Observaciones" },
      ],
      typeSearch: [
      ...
      tableColumns: [
        ...
        { key: "fullname", label: "Fecha", sortable: true },
        { key: "number_identification", label: "Almacen" },
        { key: "phone", label: "Total ajustado" },
        { key: "phone1", label: "Observaciones" },
