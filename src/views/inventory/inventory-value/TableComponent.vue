...
export default {
  ...
  data() {
    return {
      ...
      searchQuery: "",
      inputs: [
        { value: "id", title: "Producto/Servicio" },
        { value: "reason", title: "Referencia" },
        { value: "number_identification", title: "Descripción" },
        { value: "mobil", title: "Cantidad" },
        { value: "mobil", title: "Unidad" },
        { value: "mobil", title: "Estado" },
        { value: "mobil", title: "Costo promedio" },
      ],
      typeSearch: [
      ...
      tableColumns: [
        { key: "id", label: "Producto/Servicio", sortable: true },
        { key: "fullname", label: "Referencia", sortable: true },
        { key: "number_identification", label: "Descripción" },
        { key: "phone", label: "Cantidad" },
        { key: "phone1", label: "Unidad" },
        { key: "phone2", label: "Estado" },
        { key: "phone3", label: "Costo promedio" },
