  ...
  data() {
    return {
      ...
      inputs: [
        ...
        { value: "reason", title: "Dirección" },
        { value: "number_identification", title: "Observaciones" },
      ],
      typeSearch: [
      ...
      tableColumns: [
        ...
        { key: "fullname", label: "Dirección", sortable: true },
        { key: "number_identification", label: "Observaciones" },
