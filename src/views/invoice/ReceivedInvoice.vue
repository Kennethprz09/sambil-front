        ...
        <b-card no-body class="mb-0">
            ...
            <div class="m-2">
                ...
                <b-row>
                    ...
                    <b-col>
                        <div class="d-flex align-items-center justify-content-end">
                            <v-select :options="perPageOptions" :clearable="false"
                                class="per-page-selector d-inline-block mx-50" placeholder="Cuenta" />
                        </div>
                    </b-col>
                    <b-col>
                        <div class="d-flex align-items-center justify-content-end">
                            <v-select :options="perPageOptions" :clearable="false"
                                class="per-page-selector d-inline-block mx-50" placeholder="Conciliado" />
                        </div>
                    </b-col>
                    <b-col>
                        <div class="d-flex align-items-center justify-content-end">
                            <v-select :options="perPageOptions" :clearable="false"
                                class="per-page-selector d-inline-block mx-50" placeholder="Estado" />
                        </div>
                    </b-col>
                    <b-col class="d-flex">
                        <b-form-group>
