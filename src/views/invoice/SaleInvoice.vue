            ...
            <b-col md="2">
              <b-form-group>
                <v-select class="d-inline" v-model="tableSettings.input"
                  label="title" :options="inputs" :reduce="val => val.value" placeholder="Cliente" />
              </b-form-group>
            </b-col>
            <b-col md="2">
              <b-form-group>
                <v-select class="d-inline" v-model="tableSettings.typeSearch"
                  label="title" :options="typeSearch" :reduce="val => val.value" placeholder="Fecha de Inicio"/>
              </b-form-group>
            </b-col>
            <b-col md="2">
              <b-form-group>
                <v-select class="d-inline" v-model="tableSettings.typeSearch"
                  label="title" :options="typeSearch" :reduce="val => val.value" placeholder="Vigencia Hasta"/>
              </b-form-group>
            </b-col>
            <b-col md="2">
              <div class="d-flex align-items-center justify-content-end">
                <b-form-input v-model="tableSettings.searchQuery" class="d-inline-block mr-1" placeholder="Frecuencia (Meses)" />
              </div>
            </b-col>
            <b-col md="2">
              <div class="d-flex align-items-center justify-content-end">
                <b-form-input v-model="tableSettings.searchQuery" class="d-inline-block mr-1" placeholder="Termino  (Días)" />
