    ...
    <div>
        <b-card title="Nueva numeración">
            <b-row>
                ...
                <b-col sm="6" v-if="form.typeDocument.value == 1 || form.typeDocument.value == 2 || form.typeDocument.value == 3 || form.typeDocument.value == 4 || form.typeDocument.value == 5 || form.typeDocument.value == null">
                    <b-form-group>
                ...
                <b-col sm="12" class="text-center">
                    <div class="demo-inline-spacing justify-content-center">
                        ...
                        <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" @click="updateNumber()">
                            Guardar
                        </b-button>
                    </div>
                </b-col>
...
export default {
    ...
    methods: {
        ...
        updateNumber() {
            this.$http.post('/typeDocuments/updateNumber/' + this.id, this.form)
                .then(response => {
